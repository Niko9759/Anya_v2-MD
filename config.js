...
module.exports = {
     ...
     */
    ownername: process.env.Owner_Name || "Dazy",
    ownernumber: process.env.Owner_Number || "94779697328",
    ...
    sessionId: process.env.SESSION_ID || "pZKR17kwOo_A_N_Y_A_V_2_O5o6WFVzD4",
